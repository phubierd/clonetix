...
import { postAddUserAction, putEditUserAction } from 'redux/action/UserAction';
...
export default function AddUser(props) {
    ...
    const [form] = useForm()
    const { email, hoTen, maLoaiNguoiDung, matKhau, soDt, taiKhoan } = props.selectedUser
    // console.log(matKhau)
    useEffect(() => {
        form.setFieldsValue({
            email: email,
    ...
    const onFinish = (values) => {
        // console.log(values)
        dispatch(putEditUserAction(values))
    };
